...
from AppCovid.forms import BarbijosFormulario, GuantesFormulario, UserRegisterForm, UserEditForm
...
class OximetrosList(ListView):
    ...
    model = Oximetros
    template_name = "AppCovid/oximetros_list.html"
    
#Detalle - SUPER Leer - Buscar!!!!!
class OximetrosDetalle(DetailView):
    
    model = Oximetros
    template_name = "AppCovid/oximetros_detalle.html"
    
#Crear elementos
class OximetrosCreacion(CreateView):
    
    model = Oximetros
    success_url = "../oximetros/list"  #AppCovid/template/AppCoder/editar
